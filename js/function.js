...
offset(obj)
获取元素到浏览器的距离
left=所有具有定位属性的父元素的offsetLeft+所有具有定位属性的父元素的borderLeftWidth+自身的offsetLeft//自己到父元素的距离;
1.获取所有具有定位属性的父元素position=relative absolute
2.offsetLeft+borderLeftWidth
3.返回最终结果是一个对象{left:200,top:300}*/
function offset(obj){
